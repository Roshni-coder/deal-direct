// src/Components/HeroSection/AvailableForFilter.jsx
...
const AvailableForFilter = ({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        onClick={() => setOpenDropdown(openDropdown === 'availableFor' ? null : 'availableFor')}
