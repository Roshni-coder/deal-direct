        ...
        <div className="absolute top-full mt-2 bg-white rounded-xl shadow-2xl border border-gray-200 p-3 z-50 w-72">
          ...
          <div className="flex border rounded-lg overflow-hidden mb-3">
            <button
              ...
              className={`flex-1 py-3 min-h-[44px] text-sm font-semibold transition touch-action-manipulation ${projectPropertyTypeTab === "Residential"
            ...
            <button
              ...
              className={`flex-1 py-3 min-h-[44px] text-sm font-semibold transition touch-action-manipulation ${projectPropertyTypeTab === "Commercial"
                ? "bg-gray-900 text-white"
                : "bg-white text-gray-700 hover:bg-gray-50 active:bg-gray-100"
                }`}
            >
